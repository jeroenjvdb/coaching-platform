<h2>contact <small><a href="#" data-toggle="contact"><i class="fa fa-pencil"></i></a></small></h2>
<div class="row swimmer">
    <div class="col-md-2 col-xs-4">
        <img src="{{ $contact['picture'] }}" alt="">
    </div>
    <div class="col-md-10 col-xs-8 contact" data-isForm="false">
        <div class="row">
    ...
    <div class="col-md-10 col-xs-8 contact" data-isForm="true" data-form="contact" hidden>
        {!! Form::open() !!}
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div class="row">
